...
The next step is to create the models. In Frappe, models are called **DocTypes**. You can create new DocTypes from the Desk UI. **DocTypes** are made of fields called **DocField** and role based permissions are integrated into the models, these are called **DocPerms**.
...
Now, let us create the **DocTypes**.

To create a new **DocType**, go to the DocType list view and create new doctype
